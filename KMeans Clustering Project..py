...
# - Data compression
# 
# In this notebook,I have represented the algorithms for how to use k-Means for **customer segmentation** using **k-means**.
# 
# 
...
# Finally, after evaluating by Elbow and Silcouette Coefficent, we interpret that optimal number of clusters to be used here, is 2. We can further analyse this dataset considering this clustering in account.
